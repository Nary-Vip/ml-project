...
class DataTranformation:
    ...
    def get_data_transformer_object(self):
        """
        This function is reponsible for data tranformation 
        """
        ...
        try:
            ...
            logging.info(f"Numerical column: {numberical_columns}")
    ...
    def intiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Train test ds read successfull in data transformation")
            ...
            return(input_feature_train_arr, input_feature_test_arr, self.data_transformation_config.preprocessor_ob_file_path)
